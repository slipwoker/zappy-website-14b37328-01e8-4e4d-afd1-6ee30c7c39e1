        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                .then(function(data) {
                    ...
                    successMessage.style.cssText = 'background-color: #d4edda; color: #155724; padding: 1rem; border-radius: 0.25rem; margin-top: 1rem;';
                ...
                .catch(function(error) {
                    ...
                    errorMessage.style.cssText = 'background-color: #f8d7da; color: #721c24; padding: 1rem; border-radius: 0.25rem; margin-top: 1rem;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '14b37328-01e8-4e4d-afd1-6ee30c7c39e1',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '14b37328-01e8-4e4d-afd1-6ee30c7c39e1';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '14b37328-01e8-4e4d-afd1-6ee30c7c39e1';
